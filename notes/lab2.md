...
![image-20251208152634207](lab2.assets/image-20251208152634207.png)
...
![image-20251208152417322](lab2.assets/image-20251208152417322.png)
...
![image-20251208152444264](lab2.assets/image-20251208152444264.png)

#### 結果分析

StarvationTest的运行结果深入揭示了Nachos非抢占式优先级调度中饥饿现象的实际表现。

测试开始后，主线程（Thread 0，优先级0）首先获得执行机会，然後高优先级线程1（优先级5）运行，充分体现了非抢占式调度的特点。通过策略性的Yield()调用（仅在偶数次迭代时调用），精确控制了CPU让出的时机。
